...
int main(int argc, char **argv ) {
    ...
    /* 
    srvInfo is a struct with two attributes: int sd; struct sockaddr_in from
    pthread_create( &sth[i], NULL, EchoServe, (void *)srvInfo)
    ...
    */
	...
	if ( childpid == 0) {
	    ...
	    close(psd);
    /* how should the parent do a join without blocking the parent
    there is something i need to implement
    */
	}
    }
}
...
/*
void *EchoServe(void *rec)
{

same code of the stuff below
